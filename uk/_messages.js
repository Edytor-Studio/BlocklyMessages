...
Blockly.Msg.HIDE = 'Сховати елементи робочого простору';
Blockly.Msg.SHOW = 'Показати елементи робочого простору';
...
Blockly.Msg.HORIZONTAL_PARAMETERS = 'Розташувати параметри горизонтально';
Blockly.Msg.VERTICAL_PARAMETERS = 'Розташувати параметри вертикально';
Blockly.Msg.CONFIRM_DELETE = 'Підтвердити видалення';
Blockly.Msg.DELETE_ALL_BLOCKS = "Видалити всі %1 блоки?";
...
Blockly.Msg.EXPORT_IMAGE = 'Завантажити блоки як зображення';
Blockly.Msg.COLLAPSE_ALL = 'Згорнути блоки';
Blockly.Msg.EXPAND_ALL = 'Розгорнути блоки';
Blockly.Msg.ARRANGE_H = 'Розташувати блоки горизонтально';
Blockly.Msg.ARRANGE_V = 'Розташувати блоки вертикально';
Blockly.Msg.ARRANGE_S = 'Розташувати блоки по діагоналі';
Blockly.Msg.SORT_W = 'Відсортувати блоки за шириною';
Blockly.Msg.SORT_H = 'Відсортувати блоки за висотою';
Blockly.Msg.SORT_C = 'Відсортувати блоки за категорією';
Blockly.Msg.COPY_TO_BACKPACK = 'Додати до рюкзака';
Blockly.Msg.COPY_ALLBLOCKS = 'Скопіювати всі блоки до рюкзака';
Blockly.Msg.REMOVE_FROM_BACKPACK = 'Видалити з рюкзака';
Blockly.Msg.BACKPACK_GET = 'Вставити всі блоки з рюкзака';
Blockly.Msg.BACKPACK_EMPTY = 'Очистити рюкзак';
Blockly.Msg.BACKPACK_CONFIRM_EMPTY = 'Ви впевнені, що хочете очистити рюкзак?';
Blockly.Msg.BACKPACK_DOC_TITLE = "Інформація про рюкзак";
Blockly.Msg.SHOW_BACKPACK_DOCUMENTATION = "Показати документацію рюкзака";
Blockly.Msg.BACKPACK_DOCUMENTATION = "Рюкзак — це функція копіювання/вставки. Вона дозволяє копіювати блоки з одного проекту або екрану " +
" і вставляти їх у інший проект або екран. " +
" Для копіювання можна перетягнути блоки у рюкзак. Для вставки натисніть на значок рюкзака і " +
" перетягніть блоки у робочий простір." +
"</p><p>Якщо ви покинете Kodular з блоками у рюкзаку, " +
" вони залишаться там при наступному вході." +
"</p><p>Для додаткової документації та відео-інструкції дивіться:" +
'</p><p><a href="https://docs.kodular.io/guides/backpack" target="_blank">https://docs.kodular.io/guides/backpack</a>';
Blockly.Msg.ENABLE_GRID = 'Увімкнути сітку робочого простору';
Blockly.Msg.DISABLE_GRID = 'Вимкнути сітку робочого простору';
Blockly.Msg.ENABLE_SNAPPING = 'Увімкнути прив’язку до сітки';
Blockly.Msg.DISABLE_SNAPPING = 'Вимкнути прив’язку до сітки';
Blockly.Msg.DISABLE_ALL_BLOCKS = 'Вимкнути всі блоки';
Blockly.Msg.ENABLE_ALL_BLOCKS = 'Увімкнути всі блоки';
Blockly.Msg.HIDE_ALL_COMMENTS = 'Сховати всі коментарі';
Blockly.Msg.SHOW_ALL_COMMENTS = 'Показати всі коментарі';
Blockly.Msg.GENERICIZE_BLOCK = 'Зробити блок загальним';
Blockly.Msg.UNGENERICIZE_BLOCK = 'Зробити блок специфічним';
Blockly.Msg.DOWNLOAD_BLOCKS_AS_PNG = 'Завантажити блоки у форматі PNG';
...
Blockly.Msg.ERROR_BLOCK_CANNOT_BE_IN_DEFINTION = "Цей блок не можна розміщувати в визначенні";
Blockly.Msg.ERROR_SELECT_VALID_ITEM_FROM_DROPDOWN = "Виберіть допустимий елемент із випадаючого списку.";
Blockly.Msg.ERROR_DUPLICATE_EVENT_HANDLER = "Це дубль обробника події для цього компоненту.";
Blockly.Msg.ERROR_COMPONENT_DOES_NOT_EXIST = "Компонент не існує";
Blockly.Msg.ERROR_BLOCK_IS_NOT_DEFINED = "Цей блок не визначений. Видаліть його!";
Blockly.Msg.ERROR_BREAK_ONLY_IN_LOOP = "Блок 'break' можна використовувати лише в циклах";
Blockly.Msg.ERROR_INVALID_NUMBER_CONTENT = 'Цей текстовий блок не містить допустимого числа';

// Блоки кольору
Blockly.Msg.LANG_COLOUR_PICKER_HELPURL = 'https://docs.kodular.io/blocks/colors#basic';
Blockly.Msg.LANG_COLOUR_PICKER_TOOLTIP = 'Клацніть на квадрат, щоб вибрати колір.';
Blockly.Msg.LANG_COLOUR_WHITE = 'білий';
Blockly.Msg.LANG_COLOUR_LIGHT_GRAY = 'світло-сірий';
Blockly.Msg.LANG_COLOUR_GRAY = 'сірий';
Blockly.Msg.LANG_COLOUR_BLUE_GRAY = 'синьо-сірий';
Blockly.Msg.LANG_COLOUR_DARK_GRAY = 'темно-сірий';
Blockly.Msg.LANG_COLOUR_BLACK = 'чорний';
Blockly.Msg.LANG_COLOUR_RED = 'червоний';
Blockly.Msg.LANG_COLOUR_PINK = 'рожевий';
Blockly.Msg.LANG_COLOUR_PURPLE = 'фіолетовий';
Blockly.Msg.LANG_COLOUR_DEEP_PURPLE = 'глибокий фіолетовий';
Blockly.Msg.LANG_COLOUR_INDIGO = 'індиго';
Blockly.Msg.LANG_COLOUR_BLUE = 'синій';
Blockly.Msg.LANG_COLOUR_LIGHT_BLUE = 'світло-синій';
Blockly.Msg.LANG_COLOUR_CYAN = 'ціан';
Blockly.Msg.LANG_COLOUR_TEAL = 'синьо-зелений';
Blockly.Msg.LANG_COLOUR_GREEN = 'зелений';
Blockly.Msg.LANG_COLOUR_LIGHT_GREEN = 'світло-зелений';
Blockly.Msg.LANG_COLOUR_LIME = 'лаймовий';
Blockly.Msg.LANG_COLOUR_YELLOW = 'жовтий';
Blockly.Msg.LANG_COLOUR_AMBER = 'бурштиновий';
Blockly.Msg.LANG_COLOUR_ORANGE = 'помаранчевий';
Blockly.Msg.LANG_COLOUR_DEEP_ORANGE = 'глибокий помаранчевий';
Blockly.Msg.LANG_COLOUR_BROWN = 'коричневий';
Blockly.Msg.LANG_COLOUR_SPLIT_COLOUR = 'розділити колір';
Blockly.Msg.LANG_COLOUR_SPLIT_COLOUR_HELPURL = 'https://docs.kodular.io/blocks/colors#split';
Blockly.Msg.LANG_COLOUR_SPLIT_COLOUR_TOOLTIP = "Список з чотирьох елементів у діапазоні від 0 до 255, що представляють червоний, зелений, синій та альфа-компоненти.";
Blockly.Msg.LANG_COLOUR_MAKE_COLOUR = 'створити колір';
Blockly.Msg.LANG_COLOUR_MAKE_COLOUR_HELPURL = 'https://docs.kodular.io/blocks/colors#make';
Blockly.Msg.LANG_COLOUR_MAKE_COLOUR_TOOLTIP = "Колір із заданими компонентами червоного, зеленого, синього та, за бажанням, альфа.";

// Блоки управління
Blockly.Msg.LANG_CATEGORY_CONTROLS = 'Управління';
Blockly.Msg.LANG_CONTROLS_IF_HELPURL = 'https://docs.kodular.io/blocks/control#if';
Blockly.Msg.LANG_CONTROLS_IF_TOOLTIP_1 = 'Якщо значення істинне, виконує деякі інструкції.';
Blockly.Msg.LANG_CONTROLS_IF_TOOLTIP_2 = 'Якщо значення істинне, виконує перший блок інструкцій.\n' +
    'Інакше виконує другий блок інструкцій.';
Blockly.Msg.LANG_CONTROLS_IF_TOOLTIP_3 = 'Якщо перше значення істинне, виконує перший блок інструкцій.\n' +
    'Інакше, якщо друге значення істинне, виконує другий блок інструкцій.';
Blockly.Msg.LANG_CONTROLS_IF_TOOLTIP_4 = 'Якщо перше значення істинне, виконує перший блок інструкцій.\n' +
    'Інакше, якщо друге значення істинне, виконує другий блок інструкцій.\n' +
    'Якщо жодне значення не істинне, виконує останній блок інструкцій.';
Blockly.Msg.LANG_CONTROLS_IF_MSG_IF = 'якщо';
Blockly.Msg.LANG_CONTROLS_IF_MSG_ELSEIF = 'інакше якщо';
Blockly.Msg.LANG_CONTROLS_IF_MSG_ELSE = 'інакше';
Blockly.Msg.LANG_CONTROLS_IF_MSG_THEN = 'тоді';

Blockly.Msg.LANG_CONTROLS_IF_IF_TITLE_IF = 'якщо';
Blockly.Msg.LANG_CONTROLS_IF_IF_TOOLTIP = 'Додати, видалити або змінити порядок секцій\n' +
    'для переналаштування цього блока if.';

Blockly.Msg.LANG_CONTROLS_IF_ELSEIF_TITLE_ELSEIF = 'інакше якщо';
Blockly.Msg.LANG_CONTROLS_IF_ELSEIF_TOOLTIP = 'Додати умову до блока if.';

Blockly.Msg.LANG_CONTROLS_IF_ELSE_TITLE_ELSE = 'інакше';
Blockly.Msg.LANG_CONTROLS_IF_ELSE_TOOLTIP = 'Додати фінальну, універсальну умову до блока if.';

Blockly.Msg.LANG_CONTROLS_WHILEUNTIL_HELPURL = 'https://docs.kodular.io/blocks/control#while';
Blockly.Msg.LANG_CONTROLS_WHILEUNTIL_TITLE_REPEAT = 'повторювати';
Blockly.Msg.LANG_CONTROLS_WHILEUNTIL_INPUT_DO = 'робити';
Blockly.Msg.LANG_CONTROLS_WHILEUNTIL_OPERATOR_WHILE = 'поки';
Blockly.Msg.LANG_CONTROLS_WHILEUNTIL_OPERATOR_UNTIL = 'доки не';
Blockly.Msg.LANG_CONTROLS_WHILEUNTIL_TOOLTIP_WHILE = 'Поки значення істинне, виконати інструкції.';
Blockly.Msg.LANG_CONTROLS_WHILEUNTIL_TOOLTIP_UNTIL = 'Поки значення хибне, виконати інструкції.';
Blockly.Msg.LANG_CONTROLS_WHILEUNTIL_TOOLTIP_1 = 'Виконує блоки в секції "робити", поки перевірка істинна.';

Blockly.Msg.LANG_CONTROLS_FOR_HELPURL = '';
Blockly.Msg.LANG_CONTROLS_FOR_INPUT_WITH = 'рахувати з';
Blockly.Msg.LANG_CONTROLS_FOR_INPUT_VAR = 'x';
Blockly.Msg.LANG_CONTROLS_FOR_INPUT_FROM = 'від';
Blockly.Msg.LANG_CONTROLS_FOR_INPUT_TO = 'до';
Blockly.Msg.LANG_CONTROLS_FOR_INPUT_DO = 'робити';
Blockly.Msg.LANG_CONTROLS_FOR_TOOLTIP = 'Рахує від початкового числа до кінцевого.\n' +
    'Для кожного значення встановлює поточне значення в\n' +
    'змінну "%1", а потім виконує деякі інструкції.';

Blockly.Msg.LANG_CONTROLS_FORRANGE_HELPURL = 'https://docs.kodular.io/blocks/control#forrange';
Blockly.Msg.LANG_CONTROLS_FORRANGE_INPUT_ITEM = 'для кожного';
Blockly.Msg.LANG_CONTROLS_FORRANGE_INPUT_VAR = 'число';
Blockly.Msg.LANG_CONTROLS_FORRANGE_INPUT_START = 'від';
Blockly.Msg.LANG_CONTROLS_FORRANGE_INPUT_END = 'до';
Blockly.Msg.LANG_CONTROLS_FORRANGE_INPUT_STEP = 'крок';
Blockly.Msg.LANG_CONTROLS_FORRANGE_INPUT_DO = 'робити';
Blockly.Msg.LANG_CONTROLS_FORRANGE_INPUT_COLLAPSED_TEXT = 'для числа в діапазоні';
Blockly.Msg.LANG_CONTROLS_FORRANGE_INPUT_COLLAPSED_PREFIX = 'для ';
Blockly.Msg.LANG_CONTROLS_FORRANGE_INPUT_COLLAPSED_SUFFIX = ' у діапазоні';
Blockly.Msg.LANG_CONTROLS_FORRANGE_TOOLTIP = 'Виконує блоки в секції "робити" для кожного числового значення в діапазоні від початкового до кінцевого, збільшуючи значення на кожному кроці. Використовуйте задану змінну для поточного значення.';

Blockly.Msg.LANG_CONTROLS_FOREACH_HELPURL = 'https://docs.kodular.io/blocks/control#foreach';
Blockly.Msg.LANG_CONTROLS_FOREACH_INPUT_ITEM = 'для кожного';
Blockly.Msg.LANG_CONTROLS_FOREACH_INPUT_VAR = 'елемент';
Blockly.Msg.LANG_CONTROLS_FOREACH_INPUT_INLIST = 'у списку';
Blockly.Msg.LANG_CONTROLS_FOREACH_INPUT_DO = 'робити';
Blockly.Msg.LANG_CONTROLS_FOREACH_INPUT_COLLAPSED_TEXT = 'для елемента у списку';
Blockly.Msg.LANG_CONTROLS_FOREACH_INPUT_COLLAPSED_PREFIX = 'для ';
Blockly.Msg.LANG_CONTROLS_FOREACH_INPUT_COLLAPSED_SUFFIX = ' у списку';
Blockly.Msg.LANG_CONTROLS_FOREACH_TOOLTIP = 'Виконує блоки в секції "робити" для кожного елемента списку. Використовуйте задану змінну для поточного елемента.';

Blockly.Msg.LANG_CONTROLS_FOREACH_DICT_HELPURL = 'https://docs.kodular.io/blocks/control#foreachdict';
Blockly.Msg.LANG_CONTROLS_FOREACH_DICT_INPUT = 'для кожного %1 з %2 у словнику %3';
Blockly.Msg.LANG_CONTROLS_FOREACH_DICT_INPUT_DO = 'робити';
Blockly.Msg.LANG_CONTROLS_FOREACH_DICT_INPUT_KEY = 'ключ';
Blockly.Msg.LANG_CONTROLS_FOREACH_DICT_INPUT_VALUE = 'значення';
